...
class SlackIntegration(BaseIntegration):
    ...
    async def _send_notification(self, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        payload = {
            "channel": channel,
            "text": f"ℹ️ *AITIA SOC Agent Notification*\n{message}",
            "username": "AITIA SOC Agent",
...
class TeamsIntegration(BaseIntegration):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            test_payload = {
                ...
                "text": "AITIA SOC Agent connection test"
            }
            ...
            "sections": [
                {
                    ...
                    "activitySubtitle": "AITIA SOC Agent",
    ...
    async def _send_notification(self, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        card = {
            ...
            "@context": "http://schema.org/extensions",
            "themeColor": "0078D4",
            "summary": "AITIA SOC Agent Notification",
            "sections": [
                {
                    "activityTitle": "ℹ️ AITIA SOC Agent Notification",
                    "text": message
                }
            ]
        }
...
class EmailIntegration(BaseIntegration):
    ...
    async def _send_alert(self, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        subject = f"🚨 SECURITY ALERT - {severity} - AITIA SOC Agent"
        ...
        <body>
            ...
            <p><em>Generated by AITIA SOC Agent</em></p>
        </body>
        </html>
        """
    ...
    async def _send_notification(self, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        recipients = context.get("recipients", self.default_recipients)
        subject = "ℹ️ AITIA SOC Agent Notification"
        
        html_body = f"""
        <html>
        <body>
            <h2>ℹ️ AITIA SOC Agent Notification</h2>
            <p>{message}</p>
            <p><em>Generated by AITIA SOC Agent</em></p>
        </body>
        </html>
    ...
    async def _send_escalation(self, message: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        recipients = context.get("recipients", self.default_recipients)
        subject = "🔥 ESCALATION REQUIRED - AITIA SOC Agent"
